...
const defaultList2 = new ListItem(
  "Also default Item",
...
const defaultList3 = new ListItem(
...
const defaultList4 = new ListItem(
...
const defaultCompleted = new ListItem(
...
const testCompleted = new ListItem(
  "Test completed Item",
